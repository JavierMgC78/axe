...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Fondo degradado que cubre toda la pantalla (debajo de la nav) */
    body {
        background: radial-gradient(ellipse at 20% 50%, #0f0c29 0%, #302b63 50%, #24243e 100%) !important;
        font-family: 'Inter', 'Segoe UI', system-ui, sans-serif;
        color: #e2e8f0;
    }

    /* El main del template default.php: lo convertimos en columna flex
       que centra verticalmente el contenido en el espacio restante       */
    main {
        display: flex !important;
        align-items: center !important;
        justify-content: center !important;
        min-height: calc(100vh - 64px) !important; /* 64px = altura de la nav */
